(function () {
    ...
    if (window._debugMessages && window._debugMessages.length > 0) {
        for (var i = 0; i < window._debugMessages.length; i++) {
            logArea.textContent += window._debugMessages[i] + '\n';
        }
    ...
    console.log = function () {
        ...
        logArea.textContent += 'console.log: ' + msg + '\n';
    };
    console.info = function () {
        var msg = Array.prototype.slice.call(arguments).join(' ');
        logArea.textContent += 'console.info: ' + msg + '\n';
    };
    console.error = function () {
        var msg = Array.prototype.slice.call(arguments).join(' ');
        logArea.textContent += 'console.error: ' + msg + '\n';
    };
    console.warn = function () {
        var msg = Array.prototype.slice.call(arguments).join(' ');
        logArea.textContent += 'console.warn: ' + msg + '\n';
    };
